  ...
  methods: {
      saveCurrentBuild() {
        ...
        const newEquipment = {
          ...
          weaponBonus1: this.character.weaponBonus1?.id,
          weaponBonus2: this.character.weaponBonus2?.id,
          armor: this.character.armor?.id,
          armorUpgrade: this.character.armorUpgrade,
          armorBonus1: this.character.armorBonus1?.id,
          armorBonus2: this.character.armorBonus2?.id,
          armorBonus3: this.character.armorBonus3?.id,
          armorBonus4: this.character.armorBonus4?.id,
          ...
          pet: this.character.pet?.id,
          pete: this.character.pete?.id,
          petd: this.character.petd?.id,
          petc: this.character.petc?.id,
          petb: this.character.petb?.id,
          peta: this.character.peta?.id,
          petx: this.character.petx?.id,
          ...
          weapPiercing1: this.character.weapPiercing1?.id,
          weapPiercing2: this.character.weapPiercing2?.id,
          weapPiercing3: this.character.weapPiercing3?.id,
          weapPiercing4: this.character.weapPiercing4?.id,
          weapPiercing5: this.character.weapPiercing5?.id,
          weapPiercing6: this.character.weapPiercing6?.id,
          weapPiercing7: this.character.weapPiercing7?.id,
          weapPiercing8: this.character.weapPiercing8?.id,
          weapPiercing9: this.character.weapPiercing9?.id,
          weapPiercing10: this.character.weapPiercing10?.id,
        };
